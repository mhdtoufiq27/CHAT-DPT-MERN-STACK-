...
class GeminiService {
   ...
   */
  async generateResponse({ content, model, history, systemInstruction, finalPrompt }) {
    ...
    // Format history cleanly for Gemini API ensuring strict alternating user/model roles
   ...
   */
  async generateStream({ content, model, history, systemInstruction, finalPrompt, res, isAbortedFn }) {
    const text = await this.generateResponse({ content, model, history, systemInstruction, finalPrompt });
